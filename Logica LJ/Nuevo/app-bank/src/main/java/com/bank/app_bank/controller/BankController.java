package com.bank.app_bank.controller;
...
public class BankController {
    ...
    public ResponseEntity<List<Transactions>> getTransactions(@PathVariable String accountId) {
        List<Transactions> transactions = bankService.getAccountTransactions(accountId);
